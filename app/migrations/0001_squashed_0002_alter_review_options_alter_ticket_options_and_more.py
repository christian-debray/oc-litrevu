...
class Migration(migrations.Migration):
    ...
    replaces = [('app', '0001_initial'), ('app', '0002_alter_review_options_alter_ticket_options_and_more')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=150, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='uploads/tickets/%Y/%m/%d/', verbose_name='image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField(blank=True, max_length=8192, verbose_name='body')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
